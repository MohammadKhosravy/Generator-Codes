...
class Select
{
	public:
		...
		void generate_rand(int _n, int _p, int _N, int _delta, int _R);
		void generate_hard_C(int _n, int _p, int _N, int _delta, int _R);
        void generate_hard_C_and_c(int _n, int _p, int _N, int _delta, int _R);
